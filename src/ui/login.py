...
def render_login_screen():
    ...
    # Load background image (Ultra High Res Optimized)
    bg_base64 = ""
    try:
        # Construct absolute path to assets/login_bg_ultra.jpg
        bg_path = os.path.join(os.path.dirname(__file__), '..', '..', 'assets', 'login_bg_ultra.jpg')
