...
def render_login_screen():
    ...
    # Load background image (16:9 Premium Version)
    bg_base64 = ""
    try:
        # Construct absolute path to assets/login_bg_16_9.png
        bg_path = os.path.join(os.path.dirname(__file__), '..', '..', 'assets', 'login_bg_16_9.png')
